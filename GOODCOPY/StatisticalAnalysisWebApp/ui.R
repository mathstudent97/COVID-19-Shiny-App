...
ui <- fluidPage(
    ...
    navbarPage(
        title = div("COVID-19 Statistical Analysis Dashboard", style = "padding-left: 10px"),
        inverse = TRUE,
        collapsible = TRUE,
        fluid = TRUE,
        # 4 tabs.
        ...
        tags$script(HTML("var header = $('.navbar > .container-fluid');
                         header.append('<div style=\"float:right\"><a target=\"_blank\" href=\"https://github.com/mathstudent97\"><img src=\"logo.png\" alt=\"alt\" style=\"float:right;width:33px;padding-top:10px;margin-top:-50px;margin-right:10px\"> </a></div>');
    console.log(header)")
        )
    )
)
